  ...
  <div class="user-activity">
    <div class="post">
      <div class="user-block">
        ...
        <span class="username text-muted">张小里</span>
        <span class="description">登陆系统 - 7:30 今天</span>
      </div>
      <p>
        登陆系统，查看了继电器的情况，包括兼修情况，维护进度情况，工程进度情况。用户管理系统的查看，检测系统是否工作正常。
        登陆系统，查看了继电器的情况，包括兼修情况，维护进度情况，工程进度情况。用户管理系统的查看，检测系统是否工作正常。
      </p>
    ...
    <div class="post">
      <div class="user-block">
        ...
        <span class="username text-muted">李小明</span>
        <span class="description">退出系统 - 昨天</span>
      </div>
      <p>
        登陆系统，查看了继电器的情况，包括兼修情况，维护进度情况，工程进度情况。用户管理系统的查看，检测系统是否工作正常。
        登陆系统，查看了继电器的情况，包括兼修情况，维护进度情况，工程进度情况。用户管理系统的查看，检测系统是否工作正常。
    ...
    <div class="post">
      <div class="user-block">
        ...
        <span class="username">我的档案</span>
        <span class="description">图片上传 - 2天之前</span>
      </div>
