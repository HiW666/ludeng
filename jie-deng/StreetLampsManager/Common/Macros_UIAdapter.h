...
#define KBarViewToTop  ([[UIApplication sharedApplication] statusBarFrame].size.height>20?20:0)
#define kTopHeight (kStatusBarHeight + kNavBarHeight)
#define kSafeAreaBottomHeight (K_SCREEN_HEIGHT == 812.0 ? 34 : 0)
#define KToBottom (K_SCREEN_HEIGHT == 812.0 ? 54 : 0)
...
#define IS_IPHONE_Xr (K_SCREEN_HEIGHT == 896)
#define IS_IPHONE_Xs (K_SCREEN_HEIGHT ==1218)
#define IS_IPHONE_Xs_Max (K_SCREEN_HEIGHT == 1344)

#define Height_StatusBar ((IS_IPHONE_X==YES || IS_IPHONE_Xr ==YES || IS_IPHONE_Xs== YES || IS_IPHONE_Xs_Max== YES) ? 44.0 : 20.0)
#define Height_NavBar ((IS_IPHONE_X==YES || IS_IPHONE_Xr ==YES || IS_IPHONE_Xs== YES || IS_IPHONE_Xs_Max== YES) ? 88.0 : 64.0)
#define Height_TabBar ((IS_IPHONE_X==YES || IS_IPHONE_Xr ==YES || IS_IPHONE_Xs== YES || IS_IPHONE_Xs_Max== YES) ? 83.0 : 49.0)
#define Height_viewToTop ((IS_IPHONE_X==YES || IS_IPHONE_Xr ==YES || IS_IPHONE_Xs== YES || IS_IPHONE_Xs_Max== YES) ? 24 : 0)
#define Height_viewToBottom ((IS_IPHONE_X==YES || IS_IPHONE_Xr ==YES || IS_IPHONE_Xs== YES || IS_IPHONE_Xs_Max== YES) ? 34 : 0)
